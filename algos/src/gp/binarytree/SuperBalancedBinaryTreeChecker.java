...
/**
 * Using level order traversal to check whether a binary tree is super balanced.
 * Using a queue to avoid stack overflow issues. It moves level by level and so
 * it will find grossly unbalanced trees quickly.
 *
 * @author gautampriya
 */
public class SuperBalancedBinaryTreeChecker {
  ...
  public static boolean isBalanced(final BinaryTreeNode treeRoot) {

    if (treeRoot==null) // trivial case
      return true;
  ...
  public static void main(final String[] args) {
    final Result result=JUnitCore.runClasses(SuperBalancedBinaryTreeChecker.class);
